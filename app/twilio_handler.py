...
async def handle_media_stream(websocket: WebSocket, system_message: str):
    ...
    from_number = websocket.query_params.get("from_number") or shared.global_from_number
    call_id = websocket.query_params.get("call_id") or shared.global_call_id
    print(f"WebSocket connection parameters: from_number={from_number}, call_id={call_id}")
